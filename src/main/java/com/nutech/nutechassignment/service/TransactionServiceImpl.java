...
public class TransactionServiceImpl implements TransactionService {
    ...
    @Override
    public List<TransactionHistoryResponse> getAllTransaction(String email) throws SQLException {
        return transactionRepository.findAllTransactionByUser_Id(email);
    }

    @Override
    public BalanceResponse getBalance(String email) throws SQLException {
    ...
    @Override
    public TransactionServiceResponse doTransaction(String email, String service_code) throws SQLException {
        ServiceLayanan serviceLayanan = transactionRepository.getServiceLayananByService_Code(service_code);
        User user = userRepository.findUserById(email);
        ...
        return convertTransactionToTransactionResponse(transaction, serviceLayanan);
    }

    @Override
    public BalanceResponse doTopUp(String email, Long totalTopUp) throws SQLException {
        User user = userRepository.findUserById(email);
    ...
    private TransactionServiceResponse convertTransactionToTransactionResponse(Transaction transaction, ServiceLayanan serviceLayanan) {
